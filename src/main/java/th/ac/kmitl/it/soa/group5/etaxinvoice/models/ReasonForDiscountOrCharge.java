...
public class ReasonForDiscountOrCharge {

    public enum DiscountOrChargeIdentificationCode {
        ...
        DISCOUNT_FROM_USUAL_OR_LIST_PRICE ("95", "ส่วนลดในราคาปกติ"),
        ...
        DiscountOrChargeIdentificationCode(String reasonCode, String description) {
